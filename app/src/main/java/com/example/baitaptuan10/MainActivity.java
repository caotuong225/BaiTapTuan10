...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://60b54e86fe923b0017c83e52.mockapi.io/Student";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bntClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String urlGet="https://60b54e86fe923b0017c83e52.mockapi.io/Student";
                GetData(urlGet);
                //GetJson(url);
                //GetArrayJson(url);
                //PostApi(url);
        ...
        btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlDel="https://60b54e86fe923b0017c83e52.mockapi.io/Student";
                DeleteApi(urlDel);
            }
        });
        btnPut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String urlPost = "https://60b54e86fe923b0017c83e52.mockapi.io/Student";
                PostApi(urlPost);
            }
        });
    ...
    private void PostApi(String url){
                ...
                })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("name", "Tuong");
                params.put("username", "CaoTuong");
                params.put("password", "tuong");
    ...
    private void PutApi(String url){
        StringRequest stringRequest = new StringRequest(
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                HashMap<String, String> params = new HashMap<>();
                params.put("name", "Hoang");
                params.put("username", "HuyHoang");
                params.put("password", "Hoang");
